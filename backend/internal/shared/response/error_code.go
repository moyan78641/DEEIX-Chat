...
var exactErrorSpecs = map[string]errorSpec{
	...
	"billing plan already exists":                    {Code: "billing.plan_conflict", Message: "billing plan already exists"},
	"billing plan code is invalid":                   {Code: "billing.plan_code_invalid", Message: "billing plan code is invalid"},
	"billing plan code is reserved":                  {Code: "billing.plan_code_reserved", Message: "billing plan code is reserved"},
	...
	"invalid coupon code":                                          {Code: "billing.invalid_coupon_code", Message: "invalid coupon code"},
	"coupon code already exists":                                   {Code: "billing.coupon_code_conflict", Message: "coupon code already exists"},
	"coupon code is unavailable":                                   {Code: "billing.coupon_code_unavailable", Message: "coupon code is unavailable"},
	"coupon code plaintext unavailable":                            {Code: "billing.coupon_code_plaintext_unavailable", Message: "coupon code plaintext unavailable"},
	"coupon code exhausted":                                        {Code: "billing.coupon_code_exhausted", Message: "coupon code exhausted"},
	"coupon user limit exceeded":                                   {Code: "billing.coupon_user_limit_exceeded", Message: "coupon user limit exceeded"},
...
var fallbackMessages = map[string]string{
	...
	"billing.plan_conflict":                             "billing plan already exists",
	"billing.plan_code_invalid":                         "billing plan code is invalid",
	"billing.plan_code_reserved":                        "billing plan code is reserved",
	...
	"billing.invalid_coupon_code":                       "invalid coupon code",
	"billing.coupon_code_conflict":                      "coupon code already exists",
	"billing.coupon_code_unavailable":                   "coupon code is unavailable",
	"billing.coupon_code_plaintext_unavailable":         "coupon code plaintext unavailable",
	"billing.coupon_code_exhausted":                     "coupon code exhausted",
	"billing.coupon_user_limit_exceeded":                "coupon user limit exceeded",
