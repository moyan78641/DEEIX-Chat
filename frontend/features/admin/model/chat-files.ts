  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        description: "Trigger context compression when the conversation exceeds this turn count. Set 0 to disable this trigger.",
        type: "int",
      ...
      },
      {
        ...
        description: "Trigger context compression when accumulated message tokens exceed this value. Set 0 to disable this trigger.",
        type: "int",
